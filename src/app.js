        ...
        <div class="flex flex-wrap h-full">
            <div class="w-full md:w-auto h-full flex border-b md:border-b-0 md:border-r border-white/5">
                ...
                <div class="flex-1 p-4 flex flex-col min-w-0">
                    ...
                    <div class="text-xs text-gray-400" id="status-${item.id}">${i18n.t('status.pending')}</div>
                </div>
            </div>
            <div class="w-full md:w-auto ml-auto flex-shrink-0 p-2 md:p-4 flex items-center justify-center">
                <button id="download-${item.id}" class="px-4 py-2 bg-primary hover:bg-primary-hover text-white rounded-lg text-xs md:text-sm hidden">${i18n.t('btn.download')}</button>
            </div>
        </div>
    `;
